    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        if (obj.chart_series != null && obj.chart_series[0] != null) {
          ...
          container = $('#'+obj.container).parent().parent().find('h4');
          load_more(container);
          console.log(obj.filter);
          if(obj.filter){
            load_duration(container,obj.filter);
          }
...
'<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-bars"></i>More</a>'+
  ...
  function load_duration(container,data){
   duration = '<div class="filter">'+
   '<ul><li class="dropdown">'+
'<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-calendar-o"></i>'+data['text']+'</a>'+
          '<ul class="dropdown-menu" role="menu"><li><form><input type="date" class="datepicker"></form><a href="#"><i class="fa fa-check"></i>Select</a></li></ul></div>';
