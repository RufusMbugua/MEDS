...
class Ph_Alkalinity extends CI_Controller {
    ...
    function ph_alkalinity_specifications() {
    ...
    $this->load->view('ph_alkalinity/ph_alkalinity_specification',$data);
    $this->load->helper(array('form'));
    }

    function ph_alkalinity_specifications_view() {
    ...
    $this->load->view('ph_alkalinity/ph_alkalinity_specifications_view',$data);
    $this->load->helper(array('form'));
    }
    ...
    $this->load->view('ph_alkalinity/view_ph_alkalinity_monograph',$data);
    $this->load->helper(array('form'));
    }
    ...
    $this->load->view('ph_alkalinity/ph_alkalinity_view',$data);
    $this->load->helper(array('form'));
    }
    function ph_complete_worksheet() {
    ...
    $data['ph_alkalinity']=$this->db->select('*')->get_where('ph_alkalinity', array('test_request_id' => $test_request_id))->result_array();
    ...
    $this->load->view('ph_alkalinity/ph_complete_view',$data);
    $this->load->helper(array('form'));
    }
    function save(){
	...
	function save_specifications(){
       $this->load->model('ph_alkalinity_model');

        if ($this->input->post('submit')) {
            $this->ph_alkalinity_model->process_specifications();
        }                
    }
