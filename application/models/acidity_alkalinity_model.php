<?php
class Acidity_Alkalinity_Model extends CI_Model{
   ...
   function process_specifications(){
    ...
    $test_name="Acidity/Alkalinity";
    $test_type="o";

    $sql=$this->db->select_max('id')->get('acidity_alkalinity')->result();
    $test_id=$sql[0]->id;
    $test_id++;
   ...
   function process(){
    ...
    $this->db->insert('acidity_alkalinity', $data);
