        ...
        <tr>
          <td colspan="8" align="center" style="padding:8px;">
            <table border="0" align="center" cellpadding="8px" width="100%" >
              ...
              <tr>
                <td colspan="6" height="25px" align="center" style="padding:8px;border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #ffffff;"><h5>pH Test</h5></td>
              </tr>
              <tr>
                <td colspan="6" style="padding:9px;">
                  <table width="100%">
                      ...
                      <tr>
                        ...
                        <td align="left" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><input type="text" id="method" name="method" placeholder="e.g BP 2013"></td>
                      </tr>
                      <tr>
                          <td  colspan="2" height="20px" align="left" style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                          Observation</td>
                      </tr>
                      <tr>
                          <td  colspan="2" height="25px" align="center" style="padding:8px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
