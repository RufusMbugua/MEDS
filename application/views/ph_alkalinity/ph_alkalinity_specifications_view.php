          ...
          <td colspan="8" align="center" style="padding:8px;">
                ...
                <td colspan="8" style="padding:8px;">
                  <table border="0" width="100%" cellpadding="8px" align="center">
                    <tr>
                      ...
                      <td style="color:#0000ff;padding:8px;border-bottom:solid 1px #c4c4ff;"><input type="text" range="tolerance_range" id="new_min_tolerance_det" name="range_minimum" placeholder="min%" size="5"  value="<?php echo $monograph_specifications[0]['range_minimum'];?>" disabled> - <input type="text" range="tolerance_range" name="range_maximum" placeholder="max%" size="5" value="<?php echo $monograph_specifications[0]['range_maximum'];?>" disabled/></td>
                    </tr>
                  </table>
                </td>
            </tr>
            <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                <textarea rows="15" cols="180" name="monograph_specifications" disabled><?php echo $monograph_specifications[0]['monograph_specifications'];?></textarea>
              </td>
            </tr>
            <tr>
