     ...
     <div id="forms">
      ...
      <?php echo form_open('ph_alkalinity/save',array('id'=>'ph_alkalinity_view'));?>
       <table  width="75%" class="table_form" border="0" cellpadding="4px" align="center">
        ...
        <input type="hidden" name="reference_number" value="<?php echo $query['reference_number'];?>"></input>
        <tr>
        ...
        <tr>
          <td colspan="8" align="center" style="padding:8px;">
            <table border="0" align="center" cellpadding="8px" width="100%" >
              ...
              <tr>
                <td colspan="6" height="25px" align="center" style="padding:8px;border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #ffffff;"><h5><b>pH Test</b></h5></td>
              </tr>
              <tr>
                <td colspan="6" style="padding:9px;">
                  <table width="100%" align="center">
                      ...
                      <tr>
                        ...
                        <td align="left" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><input type="text" id="method" name="method" value="<?php echo $ph_alkalinity[0]['method'];?>" placeholder="e.g BP 2013" disabled> </td>
                      </tr>
                      <tr>
                          <td  colspan="2" align="center" style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                          Observation</td>
                      </tr>
                      <tr>
                          <td  colspan="2" align="center" style="padding:8px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                          <textarea cols="180" rows="10" name="observation" disabled><?php echo $ph_alkalinity[0]['observation'];?></textarea></td>
                      </tr>
                      <tr>
                        <td  align="left" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">Results</td>
                        <td  align="left" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                            <select name="comments">
                              <option><?php echo $ph_alkalinity[0]['comments'];?></option>
                              <option>COMPLIES</option>
                              <option>DOES NOT COMPLY</option>
                            </select>
                        </td>
                      </tr>
                  </table>
