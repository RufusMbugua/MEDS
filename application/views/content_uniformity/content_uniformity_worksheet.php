          ...
          <td colspan="8" align="center" style="padding:8px;">
            ...
            <tr>
              <td colspan="8" align="center" style="padding:8px;" class="singlecomponent" id="singlecomponent">
                <table width="100%" >
                  <tr>
                    <td style="text-align:left;padding:8px;border-bottom: dotted 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><a class="current" href="<?php echo base_url().'';?>">Hplc</a>&nbsp;&nbsp;<a href="<?php echo base_url().'';?>">Titration</a>&nbsp;&nbsp;<a href="<?php echo base_url().'';?>">UV (Ultraviolet)</a></td>
                  </tr>
                </table>
              </td>
            </tr>
            <tr>
              <td colspan="8" align="center" style="padding:8px;" class="multicomponent" id="multicomponent">
                <table width="100%" >
                  <tr>
                    <td style="text-align:left;padding:8px;border-bottom: dotted 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><a href="<?php echo base_url().'';?>">Hplc</a>&nbsp;&nbsp;<a href="<?php echo base_url().'';?>">Titration</a>&nbsp;&nbsp;<a href="<?php echo base_url().'';?>">UV (Ultraviolet)</a></td>
                  </tr>
                </table>
              </td>
            </tr>
              ...
              <tr>
                <td colspan="8" class="singlecomponent" style="padding:8px;">
                  <table border="0" width="80%" cellpadding="8" align="center">
                    ...
                    <tr>
                      <td colspan="2" style="padding:8px;text-align:center;"><input type="text" id="d_four_pkstd" name="d_four_pkstd" placeholder="(PKSTD)" size="5" disabled> x <input type="text" id="d_four_wt" name="d_four_wt" placeholder="(WT)" size="5"> x <input type="text" id="d_four_lc" name="d_four_lc" placeholder="(LC)" size="5" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="2" style="padding:8px;text-align:center;"><input type="text" id="d_five_pkstd" name="d_five_pkstd" placeholder="(PKSTD)" size="5" disabled> x <input type="text" id="d_five_wt" name="d_five_wt" placeholder="(WT)" size="5"> x <input type="text" id="d_five_lc" name="d_five_lc" placeholder="(LC)" size="5" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="2" style="padding:8px;text-align:center;"><input type="text" id="d_six_pkstd" name="d_six_pkstd" placeholder="(PKSTD)" size="5" disabled> x <input type="text" id="d_six_wt" name="d_six_wt" placeholder="(WT)" size="5"> x <input type="text" id="d_six_lc" name="d_six_lc" placeholder="(LC)" size="5" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="2" style="padding:8px;text-align:center;"><input type="text" id="d_seven_pkstd" name="d_seven_pkstd" placeholder="(PKSTD)" size="5" disabled> x <input type="text" id="d_seven_wt" name="d_seven_wt" placeholder="(WT)" size="5"> x <input type="text" id="d_seven_lc" name="d_seven_lc" placeholder="(LC)" size="5" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="2" style="padding:8px;text-align:center;"><input type="text" id="d_eight_pkstd" name="d_eight_pkstd" placeholder="(PKSTD)" size="5" disabled> x <input type="text" id="d_eight_wt" name="d_eight_wt" placeholder="(WT)" size="5"> x <input type="text" id="d_eight_lc" name="d_eight_lc" placeholder="(LC)" size="5" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="2" style="padding:8px;text-align:center;"><input type="text" id="d_nine_pkstd" name="d_nine_pkstd" placeholder="(PKSTD)" size="5" disabled> x <input type="text" id="d_nine_wt" name="d_nine_wt" placeholder="(WT)" size="5"> x <input type="text" id="d_nine_lc" name="d_nine_lc" placeholder="(LC)" size="5" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="2" style="padding:8px;text-align:center;"><input type="text" id="d_ten_pkstd" name="d_ten_pkstd" placeholder="(PKSTD)" size="5" disabled> x <input type="text" id="d_ten_wt" name="d_ten_wt" placeholder="(WT)" size="5"> x <input type="text" id="d_ten_lc" name="d_nine_lc" placeholder="(LC)" size="5" /></td>
                    </tr>
                    <tr>
            ...
            <tr>
                <td colspan="8" class="singlecomponent" style="padding:8px;">
                  ...
                  <tr>
                    ...
                    <td style="text-align:center;color:#000;padding:8px;border-bottom: solid 1px #c4c4ff;border-left: solid 1px #c4c4ff;background-color: #ffffff;">M= 98.5%(AV = 98.5 - X + Ks)</td>
                  </tr>
                  <tr>
