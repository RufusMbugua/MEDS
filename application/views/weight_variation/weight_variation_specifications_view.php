 ...
 <body>
  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
    ...
    <div id="form_wrapper">
      ...
      <?php echo form_open('content_uniformity/print_content_uniformity_specifications',array('id'=>'content_uniformity_specifications_view'));?>
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                <h5><b>Weight Variation Specification Details</b></h5>
              </td>
            </tr>
            <tr>
                ...
                <table width="100%" align="center">
                  <tr>
                   ...
                   <td align="center" style="padding:4px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                      <textarea rows="8" cols="180" name="monograph_specifications"><?php echo $monograph_specifications[0]['monograph_specifications']?></textarea>
                    </td>
                  <tr>
                </table>
              </td>
            ...
            <tr>
              <td style="padding:4px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">Acceptance Criteria</td>
            </tr>
            <tr>
                <td colspan="8" style="padding:8px;">
                  <table border="0" width="80%" cellpadding="8px" align="center">
                    <tr>
                      <td style="color:#0000ff;padding:8px;border-bottom:solid 1px #c4c4ff;">Acceptance Value</td>
                      <td style="color:#0000ff;padding:8px;border-bottom:solid 1px #c4c4ff;"><input type="text" name="acceptance_value" placeholder="Acceptance Value" value="<?php echo $monograph_specifications[0]['acceptance_value'];?>" size="5" disabled/></td>
                    </tr>
                    <tr>
                      <td style="color:#0000ff;padding:8px;border-bottom:solid 1px #c4c4ff;">Condition Calculation Range in %</td>
                    
                      <td style="color:#0000ff;padding:8px;border-bottom:solid 1px #c4c4ff;"><input type="text" range="tolerance_range" id="new_min_tolerance_det" name="content_from" placeholder="min%" size="5" onChange="calc_determination()" value="<?php echo $monograph_specifications[0]['range_minimum'];?>" disabled> - <input type="text" range="tolerance_range" id="new_max_tolerance_det" name="content_to" placeholder="max%" size="5" value="<?php echo $monograph_specifications[0]['range_maximum'];?>" disabled/></td>
                    </tr>
                  </table>
                </td>
            </tr>
