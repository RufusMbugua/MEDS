 ...
 <body>
  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
    ...
    <div id="form_wrapper">
      ...
      <?php echo form_open('content_uniformity/save_weight_variation_specifications',array('id'=>'weight_variation_specifications_view'));?>
                ...
                <table width="100%" align="center">
                  <tr>
                   ...
                   <td align="center" style="padding:4px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                      <textarea rows="8" cols="180" name="monograph_specifications"></textarea>
                    </td>
                  <tr>
                </table>
              </td>
                ...
                <td colspan="8" style="padding:8px;">
                  <table border="0" width="100%" cellpadding="8px" align="center">
                    <tr>
                      ...
                      <td style="color:#0000ff;padding:8px;"><input type="text" name="acceptance_value" size="5" /></td>
                    </tr>
                    <tr>
                      <td><input type="checkbox" id="range">Range</td>                   
