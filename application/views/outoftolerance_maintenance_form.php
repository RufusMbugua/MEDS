...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body>
  ...
  <div id="form_wrapper_lists">
	...
	<tr>
      <td height="15px" style="text-align: center;border-left: dashed 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;background-color:#ffff40;"><?php echo $query['id_number'];?></td>
	    <td height="15px" style="text-align: center;border-left: dashed 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;background-color:#ffff40;"><?php echo $query['description'];?></td>
	    <td height="15px" style="text-align: center;border-left: dashed 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;background-color:#ffff40;"><?php echo $query['manufacturer'];?></td>
	    <td height="15px" style="text-align: center;border-left: dashed 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;background-color:#ffff40;"><?php echo $query['serial_number'];?></td>
  ...
  <table class="table_form"  bgcolor="#c4c4ff" width="80%" height="20px" border="0" cellpadding="4px" align="center">
   ...
   <div id="performance_form" name="menu" style="display:none;"><?php include_once "application/views/outoftolerance_performance_form.php";?></div>  
   <div id="calibration_form" name="menu" style="display:none;"><?php include_once "application/views/outoftolerance_calibration_schedule_form.php";?></div>  
