  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
    ...
    <div id="form_wrapper">
     <div id="forms">
      ...
      <?php echo form_open('assay/save_cream',array('id'=>'assay_view'));?>
            ...
            <table class="table_form" border="0" align="center" cellpadding="8px" width="100%" >
              ...
              <tr>
                ...
                <tr>
                    ...
                    <td colspan="2" height="25px" style="padding:4px;border-bottom:solid 1px #bfbfbf;text-align:left;background-color:#ffffff;border-right:solid 1px #bfbfbf;"><?php echo $hplc_cream_monograph[0]['serial_number']?></td>
