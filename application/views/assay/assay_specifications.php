 ...
 <body>
  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
    ...
    <div id="form_wrapper_lists">
      ...
      <?php echo form_open('assay/save_assay_specifications',array('id'=>'save_assay_specifications'));?>
       <table class="table_form" width="75%" border="0" cellpadding="4px" align="center">
        ...
        <input type="hidden" name="assignment_id" value="<?php echo $request[0]['a'];?>"></input>
          ...
          <tr>    
              <td height="25px" style="padding:4px;border-bottom:solid 1px #bfbfbf;border-left:solid 1px #bfbfbf;border-right:solid 1px #bfbfbf;border-top:solid 1px #bfbfbf;text-align:left;background-color:#ffffff;">DOCUMENT:ANALYTICAL WORKSHEET SPECIFICATION FORM</td>
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" align="center" style="padding:4px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><h5>Assay Specification Details</h5></td>
            </tr>
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                Please fill in the test specifications as per the information on the monograph, Thank you.
              </td>
            </tr>
             <tr>
                <td colspan="8" style="padding:8px;">
                  <table border="0" width="80%" cellpadding="8px" align="center">
                    ...
                    <tr>
                      <td>Range Between</td>
                      <td style="color:#0000ff;padding:8px;"><input type="text" id="new_min_tolerance_det" name="range_minimum" placeholder="min%" size="5" onChange="calc_determination()">% - <input type="text" id="new_max_tolerance_det" name="range_maximum" placeholder="max%" size="5" onChange="calc_determination()"/>%</td>
                    </tr>
                  </table>
                </td>
            </tr>
