       ...
       <table width="75%" class="table_form" border="0" cellpadding="4px" align="center">
        ...
        <tr>
          <td colspan="8" align="center" style="padding:8px;">
            ...
            <tr><td colspan="8" style="padding:8px;"></td></tr>
            <tr>
              <td colspan="8" align="center" style="padding:4px;border-bottom: solid 10px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><h5>HPLC Area Method Oral Liquids Two Components</h5></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="8" style="padding:8px;">
                  <table border="0" width="80%" cellpadding="8px" align="center">
                    ...
                    <tr>
                      <td>Content</td>
                      <td style="color:#0000ff;padding:8px;"> <input type="text" name="from" placeholder="92.5%" size="7">to <input type="text" name="" placeholder="107.5%" size="7"> of the stated amount</input></td>
