              ...
              <table class="inner_table" width="80%" border="0" align="center" cellpadding="8px"> 
                <tr>
                 ...
                 <tr>
                    ...
                    <!-- <td height="20px" align="left" style="padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                    <input type="text" id="stdlotnumbertwo" name="std_lot_number" value=""></td> -->
                </tr>
                <tr>
                    <td align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                    ID Number</td>
                    ...
                    <!-- <td height="20px" align="left" style="padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                    <input type="text" id="stdrefnumbertwo" name="std_id_number" value=""></td> -->
                </tr>
                <tr>
                    <td align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                    Potency</td>
                    ...
                    <!-- <td height="20px" align="left" style="padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                    <input type="text" id="potency_two" name="potency_two"></td> -->
                </tr>
                <tr>
                    <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                ...
                <td colspan="8" style="padding:8px;">
                  <table class="inner_table" border="0" widt="80%" cellpadding="8px" align="center">
                    <tr>
                      ...
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Theoritical Plates</b></td>
                    ...
                    <tr>
                      ...
                      <td style="color:#0000ff;"><input type="text" id="comment_retention_time" name="comment_retention_time" disabled></td>
                      <td style="color:#0000ff;"><input type="text" id="comment_peak_area" name="comment_peak_area" disabled></td>
                      <td style="color:#0000ff;"><input type="text" id="comment_asymmetry" name="comment_asymmetry" disabled></td>
                      <td style="color:#0000ff;"><input type="text" id="comment_resolution" name="comment_resolution" disabled></td>
              ...
              <tr>
                <td colspan="8" style="padding:8px;">
                  <table border="0" width="80%" cellpadding="8" align="center">
                    ...
                    <tr>
                      <td style="padding:8px;border-bottom:dotted 1px #c4c4ff; text-align:center;"><input  class="sample_one" type="text" id="d_one_pkt" name="d_one_pkt"  placeholder="(PKT)" size="5"/ disabled> x <input type="text"  id="d_one_wstd" name="d_one_wstd" placeholder="(WSTD)" size="5"/> x <input type="text" id="d_one_awt" name="d_one_awt" placeholder="(AWT)" value="<?php if(empty($uniformity_of_dosage)){}else{echo $uniformity_of_dosage[0]['average'];}?>" size="5"/> x 100 x <input type="text" id="d_one_df" name="d_one_df" placeholder="(DF)" size="5" onChange="calc_determination()"/> x <input type="text" id="d_one_potency" name="d_one_potency" placeholder="(P)" size="5" disabled/></td>
                      <td style="padding:8px;">=<input class="sample_one" type="text" id="d_one_p_lc" name="d_one_p_lc"  placeholder="(%LC)" size="10" disabled/></td>
                    </tr>
                    <tr>
                ...
                <td colspan="8" style="padding:8px;">
                  <table border="0" width="80%" cellpadding="8px" align="center">
                    ...
                    <tr>
                      ...
                      <td style="color:#0000ff;padding:8px;"><input type="text" min="min_tolerance" id="nlt_min_tolerance_det" name="det_min" size="4" placeholder="min%" onChange="calc_determination()" disabled/> - <input type="text" min="min_tolerance" id="nlt_max_tolerance_det" name="det_max" size="4" placeholder="max%" onChange="calc_determination()" /></td>
                      <td style="color:#0000ff;padding:8px;"><input type="text" min="min_tolerance" id="min_tolerance_comment" name="min_tolerance_comment" /></td>
                    </tr>
                    <tr>
                      ...
                      <td style="color:#0000ff;padding:8px;"><input type="text" max='max_tolerance' id="ngt_min_tolerance_det" name="det_min" size="4" placeholder="min%" onChange="calc_determination()" disabled/> - <input type="text" max="max_tolerance" id="ngt_max_tolerance_det" name="det_max" size="4" placeholder="max%" onChange="calc_determination()" /></td>
                      <td style="color:#00ff00;padding:8px;"><input type="text" max='max_tolerance' id="max_tolerance_comment" name="max_tolerance_comment" /></td>
                    </tr>
                    <tr>
                      ...
                      <td style="color:#0000ff;padding:8px;"><input type="text" range="tolerance_range" id="range_tolerance_comment" name="range_tolerance_comment" /></td>
                    </tr>
                    <tr>
                      <td>SD</td>
                ...
                <td colspan="8" style="padding:8px;border-bottom:dotted 1px #c4c4ff;">
                  <table border="0" cellpadding="8px" width="80%" align="center">
                    ...
                    <tr>
                      ...
                      <td style="color:#000;padding:8px;"><input type="text" name="Sample_injection_sequence_comment" size="50"></td>
                    </tr>
                    <tr>
                      ...
                      <td style="color:#000;padding:8px;"><input type="text" name="chromatograms_attached_comment" size="50"></td>
                    </tr>
                     <tr>
                      <td style="color:#000;padding:8px;">Method Used</td>
                      <td style="color:#000;padding:8px;"></td>
                      <td colspan="2" style="color:#000;padding:8px;"><input type="text" id="method" name="method" size="50"></td>
                    </tr>
                  </table>
                </td>
            </tr>
