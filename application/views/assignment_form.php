        ...
        <tr>
          <td colspan="8" style="padding:8px;text-align:center;">
            <table class="" width="100%"  cellpadding="8px" align="center" border="0"> 
                ...
                <tr>
                  <td height="25px" colspan="2" style="padding:8px;text-align:center;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;"><b>Samples Pack</b></td>
                ...
                <tr>
                   ...
                   <td height="25px" colspan="2" style="padding:8px;text-align:center;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;"><b><?php echo $request[0]['pack_size'];?></b></td>
                   ...
                   <td height="25px" colspan="" style="padding:8px;text-align:center;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;"><input type="text" name="samples_issued" ></input></td>
                   <td height="25px" colspan="" style="padding:8px;text-align:center;background-color:#ffffff;border-left: dashed 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;">
