...
<body>
  ...
  <div id="form_wrapper">
   ...
   <?php echo form_open('finance/submit/'.$request[0]['tr'],array('id'=>'invoice_form'));?>
        ...
        <tr>
            <td colspan="8" style="padding:8px;">
               <table id="list" width="100%" class="list_view_header"   bgcolor="#ffffff" cellpadding="4px">
                  ...
                  <tr>
                    ...
                    <td style='text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;background-color:#ffffff;'><input type="hidden" name="reference_number" value="<?php echo $request[0]['reference_number'];?>"><b><?php echo $request[0]['reference_number'];?></b></td>  
                    <td style='text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;background-color:#ffffff;'><input type="hidden" name="batch_lot_number" value="<?php echo $request[0]['batch_lot_number'];?>"><b><?php echo $request[0]['batch_lot_number'];?></b></td>
                    <td style='text-align: left;padding:8px;border-bottom: solid 1px #c0c0c0;background-color:#ffffff;'><input type="hidden" name="active_ingredients" value="<?php echo $request[0]['active_ingredients'];?>"><input type="hidden" name="quantity_submitted" value="<?php echo $request[0]['quantity_submitted'];?>"><b><?php echo $request[0]['active_ingredients'].' '.$request[0]['quantity_type'].' '.$request[0]['quantity_submitted'];?></b></td>
                  ...
                  if(in_array('1', $tests)){
                   # code...
                    ...
                    <tr> 
                      ...
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice" id="unit_price_identification_cost" name="unit_price_identification_cost"></td>
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text"  id="identification_cost" name="identification_cost" disabled></td>
                    </tr>
                  <?php
                  }else{
                  ...
                  if(in_array('2', $tests)){
                    ...
                    <tr> 
                      ...
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice" id="unit_price_friability_cost" name="unit_price_friability_cost"></td>
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text"  id="friability_cost" name="friability_cost" disabled></td>
                    </tr>
                  <?php
                  }else{
                  ...
                  if(in_array('4', $tests)){
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice" id="unit_price_ph_alkalinity_cost" name="unit_price_ph_alkalinity_cost"></td>
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text"  id="ph_alkalinity_cost" name="ph_alkalinity_cost" disabled></td>
                    </tr>
                  <?php
                  }else{
                  ...
                  if(in_array('8', $tests)){
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice" id="unit_price_assay_cost" name="unit_price_assay_cost"></td>
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text"  id="assay_cost" name="assay_cost" disabled></td>
                    </tr>
                    <?php
                  }else{
                  ...
                  if(in_array('3', $tests)){
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                        <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice" id="unit_price_disintegration_cost" name="unit_price_disintegration_cost"></td>
                        <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" id="disintegration_cost" name="disintegration_cost" disabled></td>
                      </tr>
                    <?php
                  }else{
                  ...
                  if(in_array('7', $tests)){
                    ?>
                      <tr>
                        ...
                        <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                        <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice" id="unit_price_dissolution_cost" name="unit_price_dissolution_cost"></td>
                        <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" id="dissolution_cost" name="dissolution_cost" disabled></td>
                      </tr>
                  <?php
                  }else{
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice" id="unit_price_content_uniformity_cost" name="unit_price_content_uniformity_cost"></td>
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" id="content_uniformity_cost" name="content_uniformity_cost" disabled></td>
                  </tr>
                  <?php
                  }else{
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice" id="unit_price_full_monograph_cost" name="unit_price_full_monograph_cost"></td>
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" id="full_monograph_cost" name="full_monograph_cost" disabled></td>
                  </tr>
                  <?php
                  }else{
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice" id="unit_price_microbiology_cost" name="unit_price_microbiology_cost"></td>
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" id="microbiology_cost" name="microbiology_cost" disabled></td>
                  </tr>
                  <?php
                  }else{
                  ...
                  if(in_array('11', $tests)){
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice" id="unit_price_uniformity_of_dosage_cost" name="unit_price_uniformity_of_dosage_cost"></td>
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" id="uniformity_of_dosage_cost" name="uniformity_of_dosage_cost" disabled></td>
                    </tr>
                  <?php
                  }else{
                  ...
                  if(in_array('6', $tests)){
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice" id="unit_price_weight_variation_cost" name="unit_price_weight_variation_cost"></td>
                      <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" id="weight_variation_cost" name="weight_variation_cost" disabled></td>
                    </tr>
                  <?php
                  }else{
                  ...
                  if(in_array('5', $tests)){
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                        <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice"id="unit_price_related_substances_cost" name="unit_price_related_substances_cost"></td>
                        <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" id="related_substances_cost" name="related_substances_cost" disabled></td>
                      </tr>
                  <?php
                  }else{
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice" id="unit_price_water_method_cost" name="unit_price_water_method_cost"></td>
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" id="water_method_cost" name="water_method_cost" disabled></td>
                  </tr>
                  <?php
                  }else{
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"></td>
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="invoice" id="unit_price_loss_drying_cost" name="unit_price_loss_drying_cost"></td>
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" id="loss_drying_cost" name="loss_drying_cost" disabled></td>
                  </tr>
                ...
                <tr>
                    ...
                    <td style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input size="10" type="text" class="total_amount" id="total_amount" name="total_amount" ></td>                       
                </tr> 
            ...
            <table width="100%">
              <tr>
               ...
               <tr>
                 <td colspan="7" style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><textarea name="comments" cols="50" rows="5"></textarea></td>                       
               </tr>
               <tr>
                 <td colspan="7" style="text-align: center;padding:8px;border-bottom: solid 1px #c0c0c0;"><input type="submit" class="btn" id="submit" name="submit" value="Submit"></td>                       
               </tr>  
            </table>
      </form>
    </div>
