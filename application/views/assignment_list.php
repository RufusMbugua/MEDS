 ...
 <body>
  ...
  <div id="log_bar">
    <table bgcolor="f2f2f2" border="0" cellpadding="8px" align="center" width="100%">
      ...
      <tr>
         <td style="background-color: #ffffff;" width="125px"><a href="<?php echo base_url().'account_settings/index/'.$user_type_id.'/'.$user_id;?>"><img src="<?php echo base_url().'images/icons/settings2.png';?>" height="20px" width="20px"> Account Settings</a></td>
   ...
   <?php 
    ...
    if($user['logged_in']['user_type'] ==6 && $user['logged_in']['department_id'] ==0){
     ...
     ?>
        ...
        <a href="<?php echo base_url().'outoftolerance/records';?>"class="sub_menu sub_menu_link first_link"><b>Out of Tolerance</b></a>
  ...
  <div id="form_wrapper_lists">
    <div id="record_lists" style="display: block;" name="menu">
        <div id="list_view_navbar">
            <table class="rl_header" border="0" bgcolor="#ffffff" width="100%" cellpadding="8px" align="center">
                <tr>
                    <td align="right"<?php if($user['logged_in']['user_type'] ==5 || $user['logged_in']['user_type'] ==6 || $user['logged_in']['user_type'] ==0){echo"style='display:none;'";}else if($user['logged_in']['user_type'] ==3){echo "style='display:block;background-color:#ffffff;text-color:#00ff00;'";}?>>
                       <a href="javascript:slide('test_request');"><img src="<?php echo base_url().'images/icons/add.png'?>" height="20px" wieght="20px"><b>Add Test Request</b></a>
                    </td>
                </tr>
                <tr>
                    <td  align="center" style="background-color:#ffffff;padding-right:40px;border-bottom: solid 10px #f0f0ff;color: #0000fb;background-color: #e8e8ff;"><b><?php if($user['logged_in']['user_type'] ==6 || $user['logged_in']['user_type'] ==0){echo"Unassigned"." ";}else{echo"Your Assigned"." ";}?></b><b>Test Request List</b></td>
                </tr>
            </table>
        </div>
        <table id="list" class="list_view_header" width="100%" bgcolor="#ffffff" cellpadding="4px">
            ...
            ?>
                    ...
                    <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $query->applicant_ref_number;?></td>
                    <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $query->applicant_name;?></td>
                    <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $query->testing_reason;?></td>
                    <td style="text-align: center;border-bottom: solid 1px #c0c0c0;"><?php echo substr($query->date_time,0,-8);?></td>
                    <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $query->batch_lot_number;?></td>
                    <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $query->manufacturer_name;?></td>
                    <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $query->brand_name;?></td>
                    <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $query->active_ingredients;?></td>
                    <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $query->test_required;?></td>
                    <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $query->authorizer_name;?></td>
                    <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $query->received_by;?></td>
                    <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $query->laboratory_number;?></td>
                    <td <?php if($user['logged_in']['user_type'] ==6){echo"style='display:block;text-align: left;border-bottom: solid 1px #c0c0c0;background-color:#cff7fe;'";}else if($user['logged_in']['user_type'] !=6){echo"style='display:none;'";}?>>
                    <a href="javascript:slide('assignment_form');"><img src="<?php echo base_url().'images/icons/edit.png';?>" height="20px" width="20px"/>Assign</a></td>
                    <td <?php if($user['logged_in']['user_type'] ==6 ||$user['logged_in']['user_type'] ==5){echo"style='display:none;'";}else if($user['logged_in']['user_type'] ==3){echo"style='display:block;text-align: left;border-bottom: solid 1px #c0c0c0;background-color:#cff7fe;'";}?>><a href="<?php echo base_url().'view_logs/logs/'.$row->id;?>"><img src="<?php echo base_url().'images/icons/view.png';?>" height="20px" width="20px"/>Log</a>
                    <a href="<?php echo base_url().'update_request_record/Update/'.$query->id;?>"><img src="<?php echo base_url().'images/icons/edit.png';?>" height="20px" width="20px"/>edit</a></td>
                    <td <?php if($user['logged_in']['user_type'] ==5){echo"style='display:block;text-align:left;border-bottom:solid 1px #c0c0c0;background-color:#cff7fe;'";}else{echo"style='display:none;'";}?>><a href="<?php echo base_url().''.$query->id;?>"><img src="<?php echo base_url().'images/icons/lab.png';?>" height="10px" width="10px"/>Test</a></td>
    ...
    <div id="assignment_form" name="menu" style="display:none;"><?php include_once "application/views/assignment_form.php";?></div>
