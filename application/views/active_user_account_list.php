...
<div id="header"> 
  ...
  <table bgcolor="f2f2f2" border="0" cellpadding="8px" align="center" width="100%">
      <tr>
        <td style="border-bottom: solid 1px #c4c4ff;padding:8px;background-color: #ffffff;" width="200px"><a href="<?php echo base_url().'account_settings/index/'.$user_type_id.'/'.$user_id;?>"><img src="<?php echo base_url().'images/icons/settings2.png';?>" height="20px" width="20px"></h6>Account Settings</h6></a></td>
  ...
  <div id="form_wrapper_lists">
    <div id="account_lists" style="display: block" name="menu">
        <table bgcolor="#ffffff" border="0" width="100%" cellpadding="4px">
            <tr>
            ...
            <tr>
                <td align="center" style="border-bottom: solid 10px #f0f0ff;color: #0000fb;background-color: #e8e8ff;"><h5>Active User Accounts</h5></td>
            </tr>
        </table>
        <table id="list" width="100%" class="list_view_header"   bgcolor="#ffffff" cellpadding="4px">
            <thead>
                <tr>
                    <th style="border-right: dotted 1px #ddddff;" align="center" width=""></th>
                    <th style="border-right: dotted 1px #ddddff;" align="center" width="">Name</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center" width="">Email</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center" width="">Username</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center" width="">Telephone</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center" width="">User Role</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center" width="">Status</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center" width="">Created</th>
                    <th align="center" width="">Action</th>
                </tr>
            </thead>
