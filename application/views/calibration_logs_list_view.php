  ...
  <div id="form_wrapper_lists">
    <div id="account_lists" style="display: block" name="menu">
            ...
            <table class="rl_header" border="0" bgcolor="#ffffff"  width="100%" cellpadding="8px" align="center">
                <tr>
                    <td style="text-align:right;background-color:#ffffff;text-color:#00ff00;"><a href="<?php echo base_url().'calibration_requirement_records/Get';?>"><img src="<?php echo base_url().'images/icons/back.png'?>" height="20px" wieght="20px"><b>Back</b></a></td>
                </tr>
                <tr>
                    <td  align="center" style="background-color:#ffffff;padding-right:40px;border-bottom: solid 10px #f0f0ff;color: #0000fb;background-color: #e8e8ff;"><b><h3>Calibration Verification Requirement Log List</h3></b></td>
                </tr>
            </table>
        <table id="list" class="list_view_header" width="100%" cellpadding="4px">
            <thead bgcolor="#efefef" >
                <tr>
                    ...
                    <th style="border-right: dotted 1px #ddddff;" align="center">Old Id No</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">New Id No</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">Old Description</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">New Description</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">Old Manufacturer</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">New Manufacturer</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">Old Model</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">New Model</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">Old Serial Number</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">New Serial Number</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">Old Verification Number</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">New Verification Number</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">Old Verification Frequency</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">New Verification Frequency</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">Old Date</th>
                    <th style="border-right: dotted 1px #ddddff;" align="center">New Date</th>
            ...
            ?>  
                ...
                <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $row['old_description'];?></td>
                <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $row['new_description'];?></td>
                <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $row['old_manufacturer'];?></td>
                <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $row['new_manufacturer'];?></td>
                <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $row['old_model'];?></td>
                <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $row['new_model'];?></td>
                <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $row['old_serial_number'];?></td>
                <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $row['new_serial_number'];?></td>
                <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $row['old_calibration_verification_req'];?></td>
                <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $row['new_calibration_verification_req'];?></td>
                <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $row['old_calibration_verification_freq'];?></td>
                <td style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $row['new_calibration_verification_freq'];?></td>
