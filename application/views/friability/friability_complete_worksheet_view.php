      ...
      <?php echo form_open('friability/save',array('id'=>'friability_view'));?>
        ...
        <tr>
          ...
          <tr>
            ...
            <tr>
              <td colspan="4" align="center" style="padding:4px;border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #ffffff;"><h5><b>Friability Test</b></h5></td>
            </tr>
            <tr>
                ...
                <td align="left" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $friability[0]['time']?></td>
                ...
                <td align="left" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $friability[0]['revolutions']?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td  align="left" style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">Weight of 20tablets and container(g)</td>
                <td  align="center" style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $friability[0]['w_tablets_containers_bf_rotation']?></td>
                <td  align="center" style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $friability[0]['w_tablets_containers_af_rotation']?></td>
                <td style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"></td>
            </tr>
            <tr>
                <td align="left" style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">weight of container(g)</td>
                <td align="center" style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $friability[0]['w_containers_bf_rotation']?></td>
                <td align="center" style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $friability[0]['w_containers_af_rotation']?></td>
                <td style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"></td>
            </tr>
            <tr>
                <td align="left" style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">Weight of tablets/capsules(g)</td>
                <td align="center" style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $friability[0]['w_tablets_bf_rotation']?></td>
                <td align="center" style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $friability[0]['w_tablets_af_rotation']?></td> 
                <td style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="center" style="padding:8px;border-bottom: solid 5px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $friability[0]['loss_in_weight']?></td>
                <td colspan="2" align="center" style="padding:4px;border-bottom: solid 5px #c4c4ff;color: #0000fb;background-color: #ffffff;"></td>
            </tr>
            <tr>
                <td align="center" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">Acceptance Criteria</td>
            ...
            <tr>
               <td align="center" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">%Loss in Weight</td>
                <td align="left" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $friability[0]['loss_in_weight']?></td>
                <td colspan="2" align="left" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $friability[0]['comment']?></td>
            </tr>
           <tr>
            ...
            <tr>
              <td colspan="2" align="left" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><textarea rows="3" cols="80" name="specification" disabled><?php echo $monograph_specifications[0]['monograph_specifications']?></textarea></td>
              <td colspan="2" align="left" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><textarea rows="3" cols="80"  name="method" disabled><?php echo $friability[0]['method'];?></textarea></td>
            </tr>
            <tr>
            ...
            <tr>
              <td  align="center"colspan="4" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><textarea cols="160" rows="4" name="results" disabled><?php echo $friability[0]['results'];?></textarea></td>
            </tr>
            <tr>
                <td  style="padding:4px;background-color:#ffffff;border-top: solid 1px #bfbfbf;text-align: center;" colspan="4" ><input class="btn" type="submit" name="submit" id="submit" value="Print"></td>
            </tr>
       </table>
      </form>
</div>
