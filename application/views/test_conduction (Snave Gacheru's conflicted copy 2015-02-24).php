            ...
            <tr>
                ...
                <?php              
                  ...
                  if(in_array('36', $monograph_specifications)){
                    ?>
                    <td style='text-align:left;padding:4px;'><a href="<?php echo base_url().'test_dissolution/index/'.$query['a'].'/'.$request[0]['tr'];?>">Normal Tablet: UV</a>
                 <?php     
                 }else{                         
                  ?>
           ...
           <?php
            ...
            <tr>
              ...
              ?>
                ...
                <td
                 <?php 
                      if(in_array('Content Uniformity', $uniformity_of_dosage)){
            ...
            <tr>
                ...
                <td style='text-align:left;padding:4px;'>
                  ...
                  <?php       
                  }elseif(!empty($uniformity_of_dosage) && in_array('Weight Variation', $uniformity_of_dosage) && !in_array('6', $test_results_test_type)){
                  ?>
            ...
            <tr>
                ...
                <td 
                  <?php 
                      if(in_array('1',$hplc_internal_method) && !in_array('54', $monograph_specifications) && in_array('Weight Variation', $uniformity_of_dosage)){
                 ...
                 <td
                 <?php 
                      if(in_array('21', $monograph_specifications)){
            ...
            <tr>
                ...
                <td 
                  <?php 
                      if(in_array('1',$hplc_internal_method) && !in_array('k', $monograph_specifications) && !in_array('Weight Variation', $uniformity_of_dosage)){
                ...
                <td 
                  <?php 
                      if(empty($assay_monograph_hplc_area_method_single_component)){
                          ...
                          echo"style='text-align:left;padding:4px;'>";
                          ?>
                          <a href="<?php echo base_url().'assay/monograph_area_method_single_component/'.$query['a'].'/'.$request[0]['tr'];?>">Please Fill Test specification</a>
                  <?php       
                     }else{
                         echo"style='text-align:left;padding:4px;'>";
                     ?>
                      <a href="<?php echo base_url().'assay/view_monograph_hplc_area_method_single_component/'.$query['a'].'/'.$request[0]['tr'].'/';?>">View specification</a>
                    <?php
                     }
                    ?>
                </td>
