    ...
    <div id="form_wrapper_lists">
      <div id="account_lists">
         <table class="subdivider" border="0" bgcolor="#ffffff" width="100%" cellpadding="8px" align="center">
           <tr>
             <td align="right" style="padding:4px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><a href="<?php echo base_url().'client_list/Get';?>"><img src="<?php echo base_url().'images/icons/view.png';?>" height="20px" width="20px">Back To Client Records</a></td>
           </tr>
           <tr>
           ...
           <tr>
            <td height="25px" align="left"
             ...
             ?>>
             <a href="<?php echo base_url().'client_details/records/'.$client_id;?>" class="sub_menu sub_menu_link first_link"><img src="<?php echo base_url().'images/icons/view.png';?>" height="20px" width="20px">Client Samples/Test Requests</a>
             <a href="<?php echo base_url().'client_details/invoices/'.$client_id;?>" class="sub_menu sub_menu_link first_link"><img src="<?php echo base_url().'images/icons/invoice.png';?>" height="20px" width="20px">Client Invoices</a>
            </td>
          </tr>
        </table>
