              ...
              <td colspan="8" style="padding:8px;">
                <table width="100%">
                  ...
                  <tr>
                    ...
                    <td style="text-align:center;color:#000;padding:8px;border-bottom: solid 1px #c4c4ff;border-left: solid 1px #c4c4ff;background-color: #ffffff;"><input type="hidden" id="dosage" name="dosage" value="<?php echo $query['strength_concentration'];?>" > <?php echo $uniformity_of_dosage[0]['dosage'];?></td>
                    <td style="text-align:center;color:#000;padding:8px;border-bottom: solid 1px #c4c4ff;border-left: solid 1px #c4c4ff;background-color: #ffffff;"> <?php echo $uniformity_of_dosage[0]['ratio'];?></td>
                    <td style="text-align:center;color:#000;padding:8px;border-bottom: solid 1px #c4c4ff;border-right: solid 1px #c4c4ff;background-color: #ffffff;"> <?php echo $uniformity_of_dosage[0]['method'];?></td>
                  </tr>
                </table>
              </td>
            </tr>
