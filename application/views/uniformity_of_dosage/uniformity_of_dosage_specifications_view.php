 ...
 <body>
  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
    ...
    <div id="form_wrapper">
      ...
      <?php echo form_open('content_uniformity/save_uniformity_of_dosgage_specifications',array('id'=>'uniformity_of_dosage_specifications_view'));?>
        ...
        <tr>
          ...
          <tr>
            ...
            <tr>
                ...
                <td colspan="2" height="25px" style="padding:4px;border-bottom:solid 1px #bfbfbf;text-align:left;background-color:#ffffff;border-right:solid 1px #bfbfbf;"><?php if(empty($monograph[0]['serial_number'])){echo 'Does Not Exist.';}else{echo $monograph[0]['serial_number'];}?></td>
            ...
            <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                <h5><b>Uniformity of Dosage Specification Details</b></h5>
              </td>
            </tr>
            <tr>
              <td colspan="8" style="padding:8px;">
                <table width="100%" align="left">
                  <tr>
                    <td style="padding:8px;border-left: solid 1px #c4c4ff;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">Dosage Form</td>
                    <td style="padding:8px;border-right: solid 1px #c4c4ff;border-left: solid 1px #c4c4ff;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $monograph_specifications[0]['dosage_form']?>
                    </td>
                    <td style="padding:8px;border-left: solid 1px #c4c4ff;border-bottom: solid 1px #c4c4ff;border-right: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><input type="hidden" name="dosage" value="<?php echo $query['strength_concentration'];?>">Dosage of Drug (Label Claim)</td>
                  </tr>
                  <tr>
                    <td style="padding:8px;border-left: solid 1px #c4c4ff;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">Type</td>
                    <td style="padding:8px;border-right: solid 1px #c4c4ff;border-left: solid 1px #c4c4ff;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $monograph_specifications[0]['type']?>
                    </td>
                     <td style="padding:8px;border-right: solid 1px #c4c4ff;border-left: solid 1px #c4c4ff;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><?php echo $query['strength_concentration'];?></td>
                  </tr>
                </table>
              </td>
            </tr>
            <tr>
              <td colspan="8" style="padding:8px">
                <table width="100%">
                  <tr>
                    <td style="padding:4px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><b>Subtype Description</b></td>
                  </tr>
                  <tr>
                    <td align="center" style="padding:4px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                      <textarea rows="8" cols="180" name="subtype"><?php echo $monograph_specifications[0]['subtype']?></textarea>
                    </td>
                  </tr>
                </table>
              </td>
