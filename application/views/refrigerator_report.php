...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="link"style="text-align:right;padding:8px;border-bottom: solid 1px #c4c4ff;">
		 <a href="<?php echo base_url().'temperature_humidity_list/records/5';?>"><img src="<?php echo base_url().'images/icons/view.png';?>" height="20px" width="20px">Back to Refrigerator Temperature & Humidity List</a>
		</div>
