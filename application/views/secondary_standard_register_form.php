...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="meds">MEDS Secondary Reference Standard Register Form</h4>
</div>
    <?php echo validation_errors(); ?>
    <?php echo form_open('standard_register/save_secondary',array('name'=>'secondary_standard_register_form'));?>
