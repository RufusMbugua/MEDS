            ...
            <table class="table_form" border="0" align="center" cellpadding="8px" width="100%" >
              ...
              <tr>
                ...
                <tr>
                    ...
                    <td colspan="2" height="25px" style="padding:4px;border-bottom:solid 1px #bfbfbf;text-align:left;background-color:#ffffff;border-right:solid 1px #bfbfbf;"><?php echo $monograph['serial_number']?></td>
