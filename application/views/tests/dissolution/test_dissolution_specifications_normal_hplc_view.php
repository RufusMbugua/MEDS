  ...
  <?php echo validation_errors(); ?>
      <?php echo form_open('test_dissolution/save_normal_monograph',array('id'=>'assay_view'));?>
       ...
       <table class="table_form" width="75%" border="0" cellpadding="4px" align="center">
          ...
          <tr>    
              <td height="25px" style="padding:4px;border-bottom:solid 1px #bfbfbf;border-left:solid 1px #bfbfbf;border-right:solid 1px #bfbfbf;border-top:solid 1px #bfbfbf;text-align:left;background-color:#ffffff;">SPECIFICATIONS WORKSHEET</td>
              <td colspan="4" height="25px" style="padding:4px;border-bottom:solid 1px #bfbfbf;border-top:solid 1px #bfbfbf;text-align:left;background-color:#ffffff;border-right:solid 1px #bfbfbf;"> <?php echo $results['active_ingredients']." "." ".$results['test_specification'];?></td>
          ...
          <tr>
            ...
            <?php 
              if (!empty($monograph_specs)){
            ?>             
            <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"> Specification: 
               <?php 
                  if ($monograph_specs[0]['monograph_specifications']!='') {
               ?>
                      <textarea name="specifications" cols="90" rows="4"> <?php echo $monograph_specs[0]['monograph_specifications'];?></textarea> 
                <?php
                   }else{
            ...
            ?>
              ...
              <td align="left" style="padding:8px;color: #0000fb;background-color: #ffffff;">
                 <?php echo $row['component'];
                   ?><input type="hidden" name="component_name[]" value="<?php echo $row['component'];?>">
              </td>
              <td colspan="7" align="left" style="padding:8px;color: #0000fb;background-color: #ffffff;">
                <input type="text" size="80" name="specification[]" id="specification" value="<?php echo $row['component'];?>">
              </td>
              <?php
                $i++;
              ?>
