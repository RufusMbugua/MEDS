...
<div id="forms">
    ...
    <tr>
      ...
      <tr>
        ...
        <td colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['burette_id'];?></td>
        ...
        <td colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['burette_volume'];?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan = "5" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['standard_description'];?></td>
      </tr>
      <tr>
        <td colspan ="6">
          <div class="scroll">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">   
              ...
              <tr>
                ...
                <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['standard_container_1'];?></td>
                ...
                <td colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['standard_container_6'];?></td>
              </tr>
              <tr> 
                ...
                <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['container_1'];?></td>
              ...
              <tr> 
                ...
                <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['standard_weight_5'];?></td>
                <td colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['standard_weight_6'];?></td>
              </tr>
            </table>
          </div>
        </td>
      ...
      <tr>
        <td colspan = "6"align="center" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Initial temperature of titrant <?php echo $query_e['initial_temperature'];?>final temprature titrant <?php echo $query_e['final_temperature'];?> </td>
      </tr>
      <tr>
        ...
        <td colspan ="6">
          <div class="scroll">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">   
            ...
            <tr>        
              <td style="padding: 8px;"><?php echo $query_e['kf_volume_1'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['kf_volume_2'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['kf_volume_3'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['kf_volume_4'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['kf_volume_5'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['kf_volume_6'];?></td>
            </tr>
          </table>
         </div>
        </td>
          ...
          <div class="scroll">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">   
            <tr>
              ...
              <td align="center" style="padding: 8px;">6.</td>
            <tr>        
              <td style="padding: 8px;"><?php echo $query_e['titer_1'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['titer_2'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['titer_3'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['titer_4'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['titer_5'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['titer_6'];?></td>
            </tr>
           </table>
         </div>
        </td>
      ...
      <tr>        
        ...
        <td style="padding: 8px;"><?php echo $query_e['rsd_acceptance_criteria'];?></td>
        <td style="padding: 8px;"><?php echo $query_e['rsd_result'];?></td>
        <td style="padding: 8px;"><?php echo $query_e['rsd_comment'];?></td>
      </tr>
      <tr>
        ...
        <td colspan ="6">
          <div class="scroll">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">   
            ...
            <tr>
              <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of standard + container (g)</td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_standard_container_1'];?></td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_standard_container_2'];?></td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_standard_container_3'];?></td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_standard_container_4'];?></td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_standard_container_5'];?></td>
              <td colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_standard_container_6'];?></td>
            </tr>
            <tr>
              <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of container (g) </td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_container_1'];?></td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_container_2'];?></td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_container_3'];?></td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_container_4'];?></td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_container_5'];?></td>
              <td colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_container_6'];?></td>
            </tr>
            <tr>
              <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of standard (g)</td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_standard_weight_1'];?></td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_standard_weight_2'];?></td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_standard_weight_3'];?></td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_standard_weight_4'];?></td>
              <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_standard_weight_5'];?></td>
              <td colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sample_tier_standard_weight_6'];?></td>
            </tr>
        </table>
         </div>
        </td>
          ...
          <div class="scroll">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">
            <tr>
              ...
              <td align="center"style="padding: 8px;">6.</td>
            <tr>        
              <td style="padding: 8px;"><?php echo $query_e['sample_tier_kf_volume_1'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['sample_tier_kf_volume_2'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['sample_tier_kf_volume_3'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['sample_tier_kf_volume_4'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['sample_tier_kf_volume_5'];?></td>
              <td style="padding: 8px;"><?php echo $query_e['sample_tier_kf_volume_6'];?></td>
            </tr>  
           </table>
         </div>
        </td>
      ...
      <tr>
        <td colspan ="4" align ="center" style="padding: 12px;">
          <?php echo $query_e['det_1_kfv'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <?php echo $query_e['det_1_f'];?> X 100 <br/><br/>
          <?php echo $query_e['det_1_wt'];?>   X 1000
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['determination_1'];?>% water </td>
      </tr>
      <tr>   
      ...
      <tr>
        <td colspan ="4" align ="center" style="padding: 12px;">
          <?php echo $query_e['det_2_kfv'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <?php echo $query_e['det_2_f'];?> X 100 <br/><br/>
          <?php echo $query_e['det_2_wt'];?>   X 1000
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['determination_2'];?>% water </td>
      </tr>
      <tr> 
      ...
      <tr>
        <td colspan ="4" align ="center" style="padding: 12px;">
          <?php echo $query_e['det_3_kfv'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <?php echo $query_e['det_3_f'];?> X 100 <br/><br/>
          <?php echo $query_e['det_3_wt'];?>  X 1000
          <td colspan = "3"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['determination_3'];?>% water </td>
      </tr>
      <tr> 
        ...
        <td colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: solid 1px #bfbfbf;"><?php echo $query_e['average'];?> </td>
        ...
        <td colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: solid 1px #bfbfbf;"> <?php echo $query_e['equivalent'];?></td>
      </tr>
      <tr> 
        ...
        <td colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['range'];?></td>
        ...
        <td colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['rsd'];?></td>
      </tr> 
      <tr>
      ...
      <tr>   
        ...
        <td colspan = ""align="center"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['content_ac'];?></td> 
        <td colspan = ""align="center"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['content_result'];?></td>
        <td colspan = "2"align="center"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['content_comment'];?></td>
      </tr>
      <tr>   
        ...
        <td colspan = ""align="center"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sd_ac'];?></td> 
        <td colspan = ""align="center"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sd_result'];?></td>
        <td colspan = "2"align="center"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['sd_comment'];?></td>
      </tr>
      <tr>   
        ...
        <td colspan = ""align="center"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['rsd_ac'];?></td> 
        <td colspan = ""align="center"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['rsd_result_2'];?></td>
        <td colspan = "2"align="center"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['rsd_comment_2'];?></td>
      </tr><tr>
