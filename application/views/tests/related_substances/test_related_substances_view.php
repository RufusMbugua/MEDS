  ...
  <input type="hidden" name ="analyst" value ="<?php echo $user['logged_in']['fname']." ".$user['logged_in']['lname'];?>">     
   <tr>
    ...
    <tr>
      ...
      <tr>
        <td colspan="2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Potency:</td>
      ...
      <tr> 
        <td colspan="2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Lot No.: </td>
        <td colspan="4" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><input type ="text" name="lot_no" id="stdlotnumber"></td>
      </tr>
      <tr>
        <td colspan="2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Id No.: </td>
        <td colspan="4" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><input type ="text" name="id_no" id="stdrefnumber"></td>
      </tr>
       <tr>
       ...
       <tr>
        <td colspan ="6">
          ...
          <tr>
            ...
            <td style="padding: 8px;"><input type = "text" class = "impurity_1" name ="impurity_2_1" id ="impurity_2_1"></td>
            <td style="padding: 8px;"><input type = "text" class = "impurity_2" name ="impurity_2_2" id ="impurity_2_2"></td>
            <td style="padding: 8px;"><input type = "text" class = "impurity_3" name ="impurity_2_3" id ="impurity_2_3"></td>
          </tr>
          <tr>
            ...
            <td style="padding: 8px;"><input type = "text"  class = "impurity_1"name ="impurity_3_1" id ="impurity_3_1"></td>
            <td style="padding: 8px;"><input type = "text"  class = "impurity_2"name ="impurity_3_2" id ="impurity_3_2"></td>
            <td style="padding: 8px;"><input type = "text"  class = "impurity_3"name ="impurity_3_3" id ="impurity_3_3"></td>
          </tr>
          <tr>
            ...
            <td style="padding: 8px;"><input type = "text"  class = "impurity_1"name ="impurity_4_1" id ="impurity_4_1"></td>
            <td style="padding: 8px;"><input type = "text"  class = "impurity_2"name ="impurity_4_2" id ="impurity_4_2"></td>
            <td style="padding: 8px;"><input type = "text"  class = "impurity_3"name ="impurity_4_3" id ="impurity_4_3"></td>
          </tr>
           <tr>
            ...
            <td style="padding: 8px;"><input type = "text"  class = "impurity_1" name ="impurity_5_1" id ="impurity_5_1"></td>
            <td style="padding: 8px;"><input type = "text"  class = "impurity_2" name ="impurity_5_2" id ="impurity_5_2"></td>
            <td style="padding: 8px;"><input type = "text"  class = "impurity_3" name ="impurity_5_3" id="impurity_5_3"></td>
          </tr>
          <tr>
            ...
            <td style="padding: 8px;"><input type = "text" class = "sample_1_avg" name ="sample_avg" id ="sample_avg"></td>
      ...
      <tr>
        <td colspan ="6"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-right: dotted 1px #bfbfbf;color: #0000fb;border-top: dotted 1px #bfbfbf;"><b>Acceptance Criteria</b></td>
      </tr> 
      <tr>
       ...
       <td colspan ="3" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Method  <input type ="text" name="method" placeholder="e.g BP 2014"> </td>        
      </tr>
      <tr>  
