...
<div id="forms">
  ...
  echo form_open('test_identification/save_uv_monograph',array('id'=>'assay_view'));
      ?>
    ...
    <input type="hidden" id="test_type" name ="test_type" value ="<?php echo $test_type;?>">
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">Acceptance Criteria
