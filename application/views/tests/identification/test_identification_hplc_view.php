...
function post_ajax(){
  //post via ajax
  form_data = $('#test_identification_hplc_view').serialize();
  ...
  alert('Please fill all the neccesary fields')
    ...
    $.ajax({
    url:"<?php echo base_url();?>test_identification/worksheet_hplc",
    type:"POST",
    async:false,
    data:form_data,
    success: function(){
...
<div id="form_wrapper">
<div id="forms">
<form id="test_identification_hplc_view" method="post">
...
<table width="950" class ="table_form" border="0" cellpadding="4px" align="center">
   <input type="hidden" name ="assignment" value ="<?php echo $assignment;?>" id ="assignment"><input type="hidden" name ="test_request" id="test_request" value ="<?php echo $test_request;?>">
    ...
    <tr>
        <td colspan = "6" style="padding: 12px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: solid 1px #bfbfbf;color: #0000fb;"><b>Weight of Sample taken</b></td>
    </tr>
    <tr>
    ...
    <tr>  
      ...
      <tr>  
        <td colspan = "4" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Dilution</td>
    </tr>
    <tr>
      ...
      <tr>
        <td colspan = "" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><b>Standard Description:</b></td>
      ...
      <tr>
        <td colspan ="6" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color: #0000fb;" >Chromatographic System </td>
      </tr> 
      <tr>
      ...
      <tr>
        <td colspan ="6" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color: #0000fb;" ><b>Reagents</b> <input type="button" id="reagent_data" value="+" class ="btn" size="20" /> </td>
      </tr> 
      <tr><td colspan="6" style="background-color:#ffffff;">
      <div class="hide_data" id="reagent_table">
      <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%"> 
      <tr>
      <td colspan ="3" style="border-bottom:dottted 1px #c4c4ff;background-color:#ffffff;padding:8px;text-align:center;color:#0000fb;"><input type="checkbox" id="samplepowder" name="uv_type" value="std" /><b>For Powders</b></td>
      <td colspan ="3" style="border-bottom:dottted 1px #c4c4ff;background-color:#ffffff;padding:8px;text-align:center;color:#0000fb;"><input type="checkbox" id="sampleliquid" name="uv_type" value="no_std" /><b>For Liquids</b></td>
    </tr>
      <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;">Reagents 1:</td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;">Reagents 2:</td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;">Reagents 3:</td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;">Reagents 4:</td>
    ...
    <tr><td colspan="6">
      <table border="0" align="center" class ="inner_table" bgcolor="ffffff" samplepowder ="std" cellpadding="8px" width="100%">
        <tr>
     ...
     <tr>
      ...
      <tr>
        ...
        <td colspan ="4"tyle="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="column_pressure"><select name="column_pressure_select"><option value="Bar">Bar</option><option value="MPA">MPA</option><option value="PSI">PSI</option></select> </td>            
      </tr>  
      <tr> 
        ...
        <td colspan ="4"tyle="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="column_oven_temp"> <select name="column_oven_temp_select"><option value="Celsius">Celsius</option><option value="Fahrenheit">Fahrenheit</option></select> </td>       
      </tr>
      <tr>
        ...
        <td colspan ="4"tyle="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="flow_rate">ml/min</td>
      </tr>  
      <tr>
        ...
        <td colspan ="4"tyle="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="wavelength"> nm</td>       
      </tr>  
      <tr>
        <td colspan ="6" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;"><b>Calculations<br/>Chromatographic System Suitability</b>  </td>
      </tr> 
      <tr>
        <td colspan ="6" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;" ><b>Standard</b><br/>From chromatograms on -  </td>
      </tr>
      <tr>
        <td colspan ="6">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">              
      ...
      <tr>
        <td colspan ="6" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;" ><b>Sample</b><br/>From chromatograms on -  </td>
      </tr> 
      <tr>
       <td colspan ="6">
          <div class="scroll">
      ...
      <tr>
        <td colspan = "3" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">
        <?php
      ...
      <tr>
        <td colspan = "6" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-right: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;"><b>Results</b> </td>
      </tr>
      <tr>
      ...
      <tr>      
        <td colspan = "6" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-right: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;"><b>Comments</b></td>
      </tr>
      <tr>
