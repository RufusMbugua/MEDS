...
function post_ajax(){
  //post via ajax
  form_data = $('#test_identification_i_view').serialize();
  ...
  alert('Please fill all the neccesary fields')
    ...
    $.ajax({
    url:"<?php echo base_url();?>test_identification/worksheet_infrared",
    type:"POST",
    async:false,
    data:form_data,
    success: function(){
...
<div id="forms">
    ...
    <form method="POST" id="test_identification_i_view">
    ...
    <input type="hidden" name ="analyst" value ="<?php echo $user['logged_in']['fname']." ".$user['logged_in']['lname'];?>">
     ...
     <tr>
      ...
      <tr>
            ...
            <td colspan="" height="25px" style="padding:4px;border-bottom:solid 1px #bfbfbf;text-align:left;background-color:#ffffff;border-right:solid 1px #bfbfbf;"><input type="text" name="serial_number"></td>
      ...
      <tr>
        ...
        <td colspan = "2" style="padding:8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><input type = "text" name = "balance_number" id ="equipmentid" size="40"></td>
      </tr>      
      <tr>
        <td colspan ="6"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;"><b>Sample Preparation</b></td>
     </tr>  
      <tr>
        <td colspan ="2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;" >Weight of sample taken (g)</td>
      ...
      <tr>
        <td colspan ="2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;"><b>Standard Preparation</b></td>
     </tr>    
    <tr>
      ...
      <tr>
       ...
       <tr>
        <td colspan="6"  style="padding:8px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><b>Conclusion</b></td>
      </tr>
      <tr>
        <td colspan="6" style="padding:8px;border-bottom:solid 1px #c4c4ff;">
