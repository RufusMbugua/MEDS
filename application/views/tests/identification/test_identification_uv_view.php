...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 $('#save_uv_identification').click(function(){ 
     $('#save_uv_identification').hide();    
        post_ajax();

  });
function post_ajax(){
  //post via ajax
  form_data = $('#test_identification_uv_view').serialize();
  ...
  alert('Please fill all the neccesary fields')
    ...
    $.ajax({
    url:"<?php echo base_url();?>test_identification/worksheet_uv",
    type:"POST",
    async:false,
    data:form_data,
    success: function(){
...
<form id="test_identification_uv_view" method="POST">
    ...
    <tr>
        ...
        <td colspan = "4" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">          
          ...
          <option selected> </option>
              ...
              ?>
               ...
               <option value="<?php echo $c['component'];?>" class = "" data-status="<?php  //echo $c['status'];?>"><?php  echo $c['component'];?></option>
                <?php
                endforeach
                ?>
            </select>
     ...
     <tr>
        ...
        <td colspan ="4" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" class="all_input" name="uv_sample_weight" size="40"> </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="3"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" class="all_input" name="uv_sample_container" id="sample_weight_container"> </td>
      </tr>
      <tr>
        ...
        <td colspan="3"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" class="all_input" name="uv_container" id ="sample_container"> </td>
      </tr>
      <tr>
        ...
        <td colspan="3"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" class="all_input" name="uv_sample_weight_1" id ="sample_weight"> </td>
      </tr>
      <tr>  
      ...
      <tr>
        ...
        <td colspan = "4" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">          
          <select id="standard_description" class="all_input" name="uv_standard_description" >
              <option selected></option>
               <?php
      ...
      <tr>
        ...
        <td colspan = "" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_potency" class="all_input" id="potency"> </td>     
        ...
        <td colspan = "" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_lot_no" class="all_input" id="lot_no"> </td>      
        ...
        <td colspan = "" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_id_no" class="all_input" id="id_no"> </td>
      </tr>
       <tr>
        ...
        <td colspan =" "style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" class="all_input" name="uv_potency_standard_container" id="standard_container" class="all_input" > </td>
        </tr>
       <tr>
        ...
        <td colspan =" "style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" class="all_input" name="uv_potency_container" id ="container" class="all_input"> </td>
       </tr>
       <tr>
        ...
        <td colspan =" "style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" class="all_input" name="uv_standard_weight" id ="standard_weight_1" class="all_input"> </td>
      </tr>
      <tr>  
        <td colspan = "6"align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Dilution</td>
      </tr>
      ...
      <tr><td colspan="6">
        ...
        <tr> 
        <td colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><b>Reagent Description</b></td>
        <td colspan = "4" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">          
      ...
      <tr>
        <td colspan="8" style="padding:8px;border-bottom:solid 1px #c4c4ff;">
          <table border="0" width="100%" class="table_form" cellpadding="8px" align="center">
            <tr>    
              <td style="border-bottom:dottted 1px #c4c4ff;padding:8px;text-align:center;"><select class="all_input" name="choice" id="choice"><option></option><option>COMPLIES</option><option>DOESNOT COMPLY</option></select></td>
            </tr>
       </table></td>
      </tr>       
      <tr>
        <td colspan = "6" align ="center"> <a  class="btn" id="save_uv_identification" name ="save_uv_identification"> Submit</a>
