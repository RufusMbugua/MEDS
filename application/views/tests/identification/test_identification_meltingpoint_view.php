...
//function to post data when submit link is pressed
  $('#save_identification_meltingpoint').click(function(){ 
    $('#save_identification_meltingpoint').hide();    
      post_ajax();
  });
  function post_ajax(){
  //post via ajax
  form_data = $('#test_identification_meltingpoint_view').serialize();
  ...
  alert('Please fill all the neccesary fields')
    ...
    $.ajax({
      url:"<?php echo base_url();?>test_identification/worksheet_meltingpoint",
      type:"POST",
      dataType:'json',
      async:true,
      data:form_data,
  ...
  $('#clear_form').click(function(){
    $('#save_identification_meltingpoint').show();
   // $('.all_input').val('');
...
<form id="test_identification_meltingpoint_view" method="POST">
<table width="950px" class="table_form" border="0" cellpadding="4px" align="center">
    ...
    <tr>
     ...
     <tr> 
      <td colspan ="6" align ="center" style="text-align:center;background-color:#ffffff;padding-right:40px;border-bottom: solid 10px #f0f0ff;color: #0000fb;background-color: #e8e8ff;"> MEDS Identification Test Form: By Melting Point</td>
     </tr>     
      <tr>
      ...
      <tr>  
        <td colspan = "6"style="padding:4px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <textarea cols ="90" rows="3" id="results" name="results_meltingpoint"></textarea></td>  
         </tr>
      <tr>      
      ...
      <tr>
        <td colspan = "6"style="padding:4px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <textarea cols ="90" rows="3" id="comments" name="comments_meltingpoint"></textarea> </td>
      </tr>
       <tr>
     ...
     <tr>
        <td colspan = "6" align ="center"> <a class="btn" name ="save_identification_meltingpoint" id="save_identification_meltingpoint">Submit</a>
