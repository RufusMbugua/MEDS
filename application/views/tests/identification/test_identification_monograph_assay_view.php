...
<div id="forms">
 <?php echo validation_errors(); 
       echo form_open('test_identification/save_assay_monograph',array('id'=>'assay_view'));?>
           ...
           <td colspan ="6">
            ...
            <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"> Specification: 
               ...
               echo $monograph_specs[0]['monograph_specifications']; 
               }else{
            ...
            ?>
             <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"> Component(s): 
                <input type="text" size="80" name="components" id="components" value="<?php echo  $components ?>">
              </td>
            </tr>
            <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"> Specification: 
